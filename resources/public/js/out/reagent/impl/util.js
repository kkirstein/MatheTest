...
{var name_str = cljs.core.name.call(null,dashed);var vec__14766 = clojure.string.split.call(null,name_str,/-/);var start = cljs.core.nth.call(null,vec__14766,(0),null);var parts = cljs.core.nthnext.call(null,vec__14766,(1));if(cljs.core.truth_(reagent.impl.util.dont_camel_case.call(null,start)))
{return name_str;
} else
...
reagent.impl.util.partial_ifn.cljs$lang$ctorPrWriter = (function (this__9313__auto__,writer__9314__auto__,opt__9315__auto__){return cljs.core._write.call(null,writer__9314__auto__,"reagent.impl.util/partial-ifn");
});
...
var G__14768__delegate = function (self__,a){var self____$1 = this;var _ = self____$1;var or__8736__auto___14769 = self__.p;if(cljs.core.truth_(or__8736__auto___14769))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__14768 = function (self__,var_args){
var self__ = this;
var a = null;if (arguments.length > 1) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__14768__delegate.call(this,self__,a);};
G__14768.cljs$lang$maxFixedArity = 1;
G__14768.cljs$lang$applyTo = (function (arglist__14770){
var self__ = cljs.core.first(arglist__14770);
var a = cljs.core.rest(arglist__14770);
return G__14768__delegate(self__,a);
});
G__14768.cljs$core$IFn$_invoke$arity$variadic = G__14768__delegate;
return G__14768;
})()
;
reagent.impl.util.partial_ifn.prototype.apply = (function (self__,args14767){var self__ = this;
...
var G__14771__delegate = function (a){var _ = this;var or__8736__auto___14772 = self__.p;if(cljs.core.truth_(or__8736__auto___14772))
{} else
{self__.p = cljs.core.apply.call(null,cljs.core.partial,self__.f,self__.args);
}
return cljs.core.apply.call(null,self__.p,a);
};
var G__14771 = function (var_args){
var self__ = this;
var a = null;if (arguments.length > 0) {
  a = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__14771__delegate.call(this,a);};
G__14771.cljs$lang$maxFixedArity = 0;
G__14771.cljs$lang$applyTo = (function (arglist__14773){
var a = cljs.core.seq(arglist__14773);
return G__14771__delegate(a);
});
...
reagent.impl.util.clj_ifn_QMARK_ = (function clj_ifn_QMARK_(x){var or__8736__auto__ = cljs.core.ifn_QMARK_.call(null,x);if(or__8736__auto__)
{return or__8736__auto__;
} else
{var G__14777 = x;if(G__14777)
{var bit__9400__auto__ = (G__14777.cljs$lang$protocol_mask$partition1$ & (256));if((bit__9400__auto__) || (G__14777.cljs$core$IMultiFn$))
{return true;
} else
{if((!G__14777.cljs$lang$protocol_mask$partition1$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMultiFn,G__14777);
} else
{return false;
}
}
...
reagent.impl.util._not_found = (function (){var obj14779 = {};return obj14779;
})();
...
{var and__8724__auto__ = cljs.core.map_QMARK_.call(null,x);if(and__8724__auto__)
{var and__8724__auto____$1 = cljs.core.map_QMARK_.call(null,y);if(and__8724__auto____$1)
{var and__8724__auto____$2 = (cljs.core.count.call(null,x) === cljs.core.count.call(null,y));if(and__8724__auto____$2)
{return cljs.core.reduce_kv.call(null,((function (and__8724__auto____$2,and__8724__auto____$1,and__8724__auto__,or__8736__auto__){
return (function (res,k,v){var yv = cljs.core.get.call(null,y,k,reagent.impl.util._not_found);if(cljs.core.truth_((function (){var or__8736__auto____$1 = (v === yv);if(or__8736__auto____$1)
{return or__8736__auto____$1;
} else
{var or__8736__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,yv);if(or__8736__auto____$2)
{return or__8736__auto____$2;
} else
{var and__8724__auto____$3 = cljs.core.keyword_identical_QMARK_.call(null,k,new cljs.core.Keyword(null,"style","style",-496642736));if(and__8724__auto____$3)
...
{var and__8724__auto__ = (cljs.core.count.call(null,v1) === cljs.core.count.call(null,v2));if(and__8724__auto__)
{return cljs.core.reduce_kv.call(null,((function (and__8724__auto__,or__8736__auto__){
return (function (res,k,v){var v_SINGLEQUOTE_ = cljs.core.nth.call(null,v2,k);if(cljs.core.truth_((function (){var or__8736__auto____$1 = (v === v_SINGLEQUOTE_);if(or__8736__auto____$1)
{return or__8736__auto____$1;
} else
{var or__8736__auto____$2 = reagent.impl.util.identical_ish_QMARK_.call(null,v,v_SINGLEQUOTE_);if(or__8736__auto____$2)
{return or__8736__auto____$2;
} else
{var and__8724__auto____$1 = cljs.core.map_QMARK_.call(null,v);if(and__8724__auto____$1)
