...
{return (function() { 
var G__14640__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__8736__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__8736__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__14643 = res;(G__14643[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__14643;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__14644){var vec__14646 = p__14644;var id = cljs.core.nth.call(null,vec__14646,(0),null);var class$ = cljs.core.nth.call(null,vec__14646,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_14647 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_14647 === "key")))
{(o[pname_14647] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__14650 = jsprops;(G__14650["defaultValue"] = value);
(G__14650["value"] = null);
(G__14650["onChange"] = ((function (G__14650,on_change,value){
return (function (p1__14648_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14648_SHARP_);
});})(G__14650,on_change,value))
);
return G__14650;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__14656 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__14656,(0),null);var id = cljs.core.nth.call(null,vec__14656,(1),null);var class$ = cljs.core.nth.call(null,vec__14656,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__14658 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__14658,(0),null);var id_class = cljs.core.nth.call(null,vec__14658,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj14662 = {};(obj14662[reagent.impl.util.cljs_argv] = v);
(obj14662[reagent.impl.util.cljs_level] = level);
return obj14662;
})();var k_14663 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__14664 = (((k_14663 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_14663);if((k_SINGLEQUOTE__14664 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__14664);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__9606__auto___14665 = a.length;var i_14666 = (0);while(true){
if((i_14666 < n__9606__auto___14665))
{(a[i_14666] = reagent.impl.template.as_component.call(null,(a[i_14666]),level_SINGLEQUOTE_));
{
var G__14667 = (i_14666 + (1));
i_14666 = G__14667;
continue;
}
} else
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__9606__auto___14668 = a.length;var i_14669 = (0);while(true){
if((i_14669 < n__9606__auto___14668))
{if((i_14669 >= first_child))
{(a[i_14669] = reagent.impl.template.as_component.call(null,(a[i_14669]),level));
} else
{}
{
var G__14670 = (i_14669 + (1));
i_14669 = G__14670;
continue;
}
} else
