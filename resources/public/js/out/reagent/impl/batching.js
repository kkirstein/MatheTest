...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__8736__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__8736__auto__))
...
{var C_14623 = (a[i]);if(cljs.core.truth_(C_14623.cljsIsDirty))
{C_14623.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__9313__auto__,writer__9314__auto__,opt__9315__auto__){return cljs.core._write.call(null,writer__9314__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_14625 = C.cljsRatom;if(!((ratom_14625 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_14625);
} else
{}
