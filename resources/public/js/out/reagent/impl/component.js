...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_14609 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null)))))))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__14610 = n;switch (G__14610) {
case (1):
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14609;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__14613 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__14613) {
...
{return (function() { 
var G__14615__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
...
{var G__14618 = f;(G__14618["__reactDontBind"] = true);
return G__14618;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__8724__auto__ = wrap;if(cljs.core.truth_(and__8724__auto__))
{return f;
} else
...
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__8736__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__8736__auto__))
{return or__8736__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",-1408033454).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(("Render must be a function, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun))))+"\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"render-fun","render-fun",-1209513086,null)))))))})());var name = (function (){var or__8736__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__8736__auto__))
{return or__8736__auto__;
} else
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__14620 = o;(G__14620[cljs.core.name.call(null,k)] = v);
return G__14620;
}),{},m);
});
...
return (function() { 
var G__14621__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
...
var args = cljs.core.seq(arglist__14622);
