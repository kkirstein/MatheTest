...
var G__14604__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
var G__14604 = function (x,var_args){
var rest = null;if (arguments.length > 1) {
  rest = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__14604__delegate.call(this,x,rest);};
G__14604.cljs$lang$maxFixedArity = 1;
G__14604.cljs$lang$applyTo = (function (arglist__14605){
var x = cljs.core.first(arglist__14605);
var rest = cljs.core.rest(arglist__14605);
return G__14604__delegate(x,rest);
});
...
partial.cljs$lang$applyTo = (function (arglist__14606){
