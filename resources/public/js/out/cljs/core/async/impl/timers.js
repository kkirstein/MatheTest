...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9313__auto__,writer__9314__auto__,opt__9315__auto__){return cljs.core._write.call(null,writer__9314__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_19457 = (0);while(true){
if((i_19457 < arr.length))
{(arr[i_19457] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9313__auto__,writer__9314__auto__,opt__9315__auto__){return cljs.core._write.call(null,writer__9314__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19464 = (self__.level + (1));while(true){
if((i_19464 <= (new_level + (1))))
{(update[i_19464] = self__.header);
{
var G__19465 = (i_19464 + (1));
i_19464 = G__19465;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19466 = (0);while(true){
if((i_19466 <= self__.level))
{var links_19467 = (update[i_19466]).forward;if(((links_19467[i_19466]) === x__$1))
{(links_19467[i_19466] = (x__$1.forward[i_19466]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__8736__auto__ = (cljs.core.truth_((function (){var and__8724__auto__ = me;if(cljs.core.truth_(and__8724__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__8724__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__8736__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__8736__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__8736__auto__,timeout__$1,me))
,msecs);
